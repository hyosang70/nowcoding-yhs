...
Blockly.Msg["ARROW_180"] = "⟳ ";  // untranslated
Blockly.Msg["ARROW_AHEAD"] = "↑ ";  // untranslated
Blockly.Msg["ARROW_CROSS"] = "⤧ ";  // untranslated
Blockly.Msg["ARROW_LEFT"] = "↰ ";  // untranslated
Blockly.Msg["ARROW_LEFT_45"] = "↖ ";  // untranslated
Blockly.Msg["ARROW_LEFT_AND_RIGHT"] = "⇆ ";  // untranslated
Blockly.Msg["ARROW_RIGHT"] = "↱ ";  // untranslated
Blockly.Msg["ARROW_RIGHT_45"] = "↗ ";  // untranslated
Blockly.Msg["BKY_CONTROLS_UNTIL_MAZE_NOWCODING_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#repeat";  // untranslated
...
Blockly.Msg["LOGIC_MAZE_PATH_CHECK_1_CONDITION_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#values";  // untranslated
Blockly.Msg["LOGIC_MAZE_PATH_CHECK_1_CONDITION_PATH_AHEAD"] = "path ' + Blockly.Msg.ARROW_AHEAD + 'ahead";  // untranslated
Blockly.Msg["LOGIC_MAZE_PATH_CHECK_1_CONDITION_PATH_LEFT"] = "path ' + Blockly.Msg.ARROW_LEFT + ' to the left";  // untranslated
Blockly.Msg["LOGIC_MAZE_PATH_CHECK_1_CONDITION_PATH_RIGHT"] = "path ' + Blockly.Msg.ARROW_RIGHT + ' to the right";  // untranslated
Blockly.Msg["LOGIC_MAZE_PATH_CHECK_1_CONDITION_TOOLTIP"] = "Returns either true or false.";  // untranslated
Blockly.Msg["LOGIC_MAZE_PATH_CHECK_2_CONDITION_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#values";  // untranslated
Blockly.Msg["LOGIC_MAZE_PATH_CHECK_2_CONDITION_TOOLTIP"] = "Returns either true or false.";  // untranslated
Blockly.Msg["LOGIC_MAZE_TURN_CONDITION_AHEAD_AND_LEFT"] = "path ' + Blockly.Msg.ARROW_LEFT + 'ahead and to the left";  // untranslated
Blockly.Msg["LOGIC_MAZE_TURN_CONDITION_AHEAD_AND_RIGHT"] = "path ' + Blockly.Msg.ARROW_RIGHT + 'ahead and to the right";  // untranslated
Blockly.Msg["LOGIC_MAZE_TURN_CONDITION_LEFT_45"] = "path ' + Blockly.Msg.ARROW_LEFT_45 + ' left 45";  // untranslated
Blockly.Msg["LOGIC_MAZE_TURN_CONDITION_PATH_CROSSROAD"] = "path ' + Blockly.Msg.ARROW_CROSS + ' crossroad";  // untranslated
Blockly.Msg["LOGIC_MAZE_TURN_CONDITION_RIGHT_45"] = "path ' + Blockly.Msg.ARROW_RIGHT_45 + ' right 45";  // untranslated
Blockly.Msg["LOGIC_MAZE_TURN_CONDITION_RIGHT_AND_LEFT"] = "path ' + Blockly.Msg.ARROW_LEFT_AND_RIGHT + ' to the right and to the left";  // untranslated
Blockly.Msg["LOGIC_MAZE_TURN_PIECE_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#values";  // untranslated
Blockly.Msg["LOGIC_MAZE_TURN_PIECE_TOOLTIP"] = "Returns either true or false.";  // untranslated
...
Blockly.Msg["MAZE_PATH_DEFAULT_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#values";  // untranslated
Blockly.Msg["MAZE_PATH_DEFAULT_TOOLTIP"] = "Returns either true or false.";  // untranslated
Blockly.Msg["MAZE_TURN_PIECE_HELPURL"] = "https://github.com/google/blockly/wiki/Text#printing-text";  // untranslated
Blockly.Msg["MAZE_TURN_PIECE_TITLE"] = "turn %1";  // untranslated
Blockly.Msg["MAZE_TURN_PIECE_TOOLTIP"] = "Print the specified text, number or other value.";  // untranslated
Blockly.Msg["MOVE_FORWARD_HELPURL"] = "move forward Helpuyrl";  // untranslated
Blockly.Msg["MOVE_FORWARD_TITLE"] = "move forward";  // untranslated
Blockly.Msg["MOVE_FORWARD_TOOLTIP"] = "move forward.Tooltip";  // untranslated
...
Blockly.Msg["NOWCODINGMAZE_GREEN"] = "#94e854";  // untranslated
Blockly.Msg["NOWCODINGMAZE_HUE"] = "10";  // untranslated
Blockly.Msg["NOWCODINGMAZE_ORANGE"] = "210";  // untranslated
Blockly.Msg["NOWCODINGMAZE_PURPLE"] = "290";  // untranslated
...
Blockly.Msg["TURN_LR_ANGLE_HELPURL"] = "turn lr";  // untranslated
Blockly.Msg["TURN_LR_ANGLE_TOOLTIP"] = "turn lr";  // untranslated
Blockly.Msg["TURN_LR_ANGLE_TOOLTIP_TURN180"] = "turn ' + Blockly.Msg.ARROW_180 + ' 180";  // untranslated
Blockly.Msg["TURN_LR_ANGLE_TOOLTIP_TURNLEFT45"] = "turn ' + Blockly.Msg.ARROW_LEFT_45 + ' left 45";  // untranslated
Blockly.Msg["TURN_LR_ANGLE_TOOLTIP_TURNLEFT90"] = "turn ' + Blockly.Msg.ARROW_LEFT + ' left 90";  // untranslated
Blockly.Msg["TURN_LR_ANGLE_TOOLTIP_TURNRIGHT45"] = "turn ' + Blockly.Msg.ARROW_RIGHT_45 + ' right 45";  // untranslated
Blockly.Msg["TURN_LR_ANGLE_TOOLTIP_TURNRIGHT90"] = "turn ' + Blockly.Msg.ARROW_RIGHT + ' right 90";  // untranslated
Blockly.Msg["TURN_LR_HELPURL"] = "turn lr";  // untranslated
Blockly.Msg["TURN_LR_TOOLTIP"] = "turn lr";  // untranslated
Blockly.Msg["TURN_LR_TOOLTIP_TURNLEFT"] = "turn ' + Blockly.Msg.ARROW_LEFT + ' left";  // untranslated
Blockly.Msg["TURN_LR_TOOLTIP_TURNRIGHT"] = "turn ' + Blockly.Msg.ARROW_RIGHT + ' right";  // untranslated
