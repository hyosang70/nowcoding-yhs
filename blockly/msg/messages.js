...
Blockly.Msg.CONTROLS_IF_MSG_DO = Blockly.Msg.CONTROLS_REPEAT_INPUT_DO;
...
Blockly.Msg.ARROW_AHEAD = '\u2191 ';
Blockly.Msg.ARROW_LEFT = '\u21B0 ';
Blockly.Msg.ARROW_RIGHT = '\u21B1 ';
Blockly.Msg.ARROW_LEFT_AND_RIGHT = '\u21C6 ';
Blockly.Msg.ARROW_LEFT_45 = '\u2196 ';
Blockly.Msg.ARROW_RIGHT_45 = '\u2197 ';
Blockly.Msg.ARROW_180 = '\u27F3 ';
Blockly.Msg.ARROW_CROSS = '\u2927 ';

//NOWCODING_MAZE HUE
Blockly.Msg.NOWCODINGMAZE_HUE = '10';
Blockly.Msg.NOWCODINGMAZE_GREEN = '#94e854';
Blockly.Msg.NOWCODINGMAZE_PURPLE = '290';
Blockly.Msg.NOWCODINGMAZE_ORANGE = '210';



//NOWCODING_MAZE TURN
Blockly.Msg.TURN_LR_TOOLTIP = 'turn lr';
Blockly.Msg.TURN_LR_HELPURL = 'turn lr';
Blockly.Msg.TURN_LR_TOOLTIP_TURNLEFT = 'turn ' + Blockly.Msg.ARROW_LEFT + ' left';
Blockly.Msg.TURN_LR_TOOLTIP_TURNRIGHT = 'turn ' + Blockly.Msg.ARROW_RIGHT + ' right';

//NOWCODING_MAZE TURN ANGLE
Blockly.Msg.TURN_LR_ANGLE_TOOLTIP = 'turn lr';
Blockly.Msg.TURN_LR_ANGLE_HELPURL = 'turn lr';
Blockly.Msg.TURN_LR_ANGLE_TOOLTIP_TURNLEFT90 = 'turn ' + Blockly.Msg.ARROW_LEFT + ' left 90';
Blockly.Msg.TURN_LR_ANGLE_TOOLTIP_TURNRIGHT90 = 'turn ' + Blockly.Msg.ARROW_RIGHT + ' right 90';
Blockly.Msg.TURN_LR_ANGLE_TOOLTIP_TURNLEFT45 = 'turn ' + Blockly.Msg.ARROW_LEFT_45 + ' left 45';
Blockly.Msg.TURN_LR_ANGLE_TOOLTIP_TURNRIGHT45 = 'turn ' + Blockly.Msg.ARROW_RIGHT_45 + ' right 45';
Blockly.Msg.TURN_LR_ANGLE_TOOLTIP_TURN180 = 'turn ' + Blockly.Msg.ARROW_180 + ' 180';


//NOWCODING_MAZE MOVE_FORWARD
Blockly.Msg.MOVE_FORWARD_TITLE = 'move forward';
Blockly.Msg.MOVE_FORWARD_TOOLTIP = 'move forward.Tooltip';
Blockly.Msg.MOVE_FORWARD_HELPURL = 'move forward Helpuyrl';

//NOWCODING_MAZE LOGIC_MAZE_TURN_PIECE
Blockly.Msg.LOGIC_MAZE_TURN_PIECE_HELPURL = 'https://github.com/google/blockly/wiki/Logic#values';
Blockly.Msg.LOGIC_MAZE_TURN_PIECE_LEFT = Blockly.Msg.ARROW_LEFT + ' left';
Blockly.Msg.LOGIC_MAZE_TURN_PIECE_RIGHT = Blockly.Msg.ARROW_RIGHT + ' right';
Blockly.Msg.LOGIC_MAZE_TURN_PIECE_TOOLTIP = 'Returns either true or false.';

Blockly.Msg.MAZE_PATH_DEFAULT_HELPURL = 'https://github.com/google/blockly/wiki/Logic#values';
Blockly.Msg.MAZE_PATH_DEFAULT_LEFT = Blockly.Msg.ARROW_LEFT + ' left';
Blockly.Msg.MAZE_PATH_DEFAULT_RIGHT = Blockly.Msg.ARROW_RIGHT + ' right';
Blockly.Msg.MAZE_PATH_DEFAULT_TOOLTIP = 'Returns either true or false.';




Blockly.Msg.MAZE_TURN_PIECE_HELPURL = 'https://github.com/google/blockly/wiki/Text#printing-text';
Blockly.Msg.MAZE_TURN_PIECE_TITLE = 'turn %1';
Blockly.Msg.MAZE_TURN_PIECE_TOOLTIP = 'Print the specified text, number or other value.';
...
//NOWCODING_MAZE LOGIC_MAZE_PATH_CHECK_1_CONDITION
Blockly.Msg.LOGIC_MAZE_PATH_CHECK_1_CONDITION_HELPURL = 'https://github.com/google/blockly/wiki/Logic#values';
Blockly.Msg.LOGIC_MAZE_PATH_CHECK_1_CONDITION_PATH_AHEAD = 'path ' + Blockly.Msg.ARROW_AHEAD + 'ahead';
Blockly.Msg.LOGIC_MAZE_PATH_CHECK_1_CONDITION_PATH_LEFT = 'path ' + Blockly.Msg.ARROW_LEFT + ' to the left';
Blockly.Msg.LOGIC_MAZE_PATH_CHECK_1_CONDITION_PATH_RIGHT = 'path ' + Blockly.Msg.ARROW_RIGHT + ' to the right';
Blockly.Msg.LOGIC_MAZE_PATH_CHECK_1_CONDITION_TOOLTIP = 'Returns either true or false.';

//NOWCODING_MAZE LOGIC_MAZE_PATH_CHECK_2_CONDITION
Blockly.Msg.LOGIC_MAZE_PATH_CHECK_2_CONDITION_HELPURL = 'https://github.com/google/blockly/wiki/Logic#values';
Blockly.Msg.LOGIC_MAZE_TURN_CONDITION_PATH_CROSSROAD = 'path ' + Blockly.Msg.ARROW_CROSS + ' crossroad';
Blockly.Msg.LOGIC_MAZE_TURN_CONDITION_AHEAD_AND_RIGHT = 'path ' + Blockly.Msg.ARROW_RIGHT + 'ahead and to the right';
Blockly.Msg.LOGIC_MAZE_TURN_CONDITION_AHEAD_AND_LEFT = 'path ' + Blockly.Msg.ARROW_LEFT + 'ahead and to the left';
Blockly.Msg.LOGIC_MAZE_TURN_CONDITION_RIGHT_AND_LEFT = 'path ' + Blockly.Msg.ARROW_LEFT_AND_RIGHT + ' to the right and to the left';
Blockly.Msg.LOGIC_MAZE_TURN_CONDITION_RIGHT_45 = 'path ' + Blockly.Msg.ARROW_RIGHT_45 + ' right 45';
Blockly.Msg.LOGIC_MAZE_TURN_CONDITION_LEFT_45 = 'path ' + Blockly.Msg.ARROW_LEFT_45 + ' left 45';
Blockly.Msg.LOGIC_MAZE_PATH_CHECK_2_CONDITION_TOOLTIP = 'Returns either true or false.';



//NOWCODING_MAZE WHILEUNTIL_
Blockly.Msg.BKY_CONTROLS_UNTIL_MAZE_NOWCODING_HELPURL = 'https://github.com/google/blockly/wiki/Loops#repeat';
