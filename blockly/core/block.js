...
Blockly.Block.prototype.setNowCodingBlockType = function (blockType) {
  this.NowCodingBlockType = blockType;
};

Blockly.Block.prototype.setControlInputButton = function (op, name, parent) {
  this.controlButton = new Blockly.ControlIcon(op, this, name, parent, this.getHeightWidth());
};

Blockly.Block.prototype.redrawControlButton = function() {
  if(this.controlButton) {
    this.controlButton.redraw();
  } else {
    console.log("ControlButton for", this, "doesn't exist")
  }
};
...
Blockly.Block.prototype.jsonInit = function (json) {
  ...
  //Nowocoding custom
  if (json['NowCodingBlockType'] !== undefined) {
    var blockType = json['NowCodingBlockType'];
    this.setNowCodingBlockType(blockType);
  }
