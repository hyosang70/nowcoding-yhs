...
Blockly.RenderedConnection.prototype.highlight = function () {
  ...
  if (this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE) {
    // steps = 'm 0,0 ' + ' v ' + (Blockly.BlockSvg.TAB_HEIGHT + 4);
    // highlight connection hole
    this.steps = 'M 68,0 h -68  a 3,3 0 0,0 -3,3 v 21  a 3,3 0 0,0 3,3 h 68  a 3,3 0 0,0 3,-3 v -21  a 3,3 0 0,0 -3,-3 z';
    //TODO[29/07/19]: Lee Middlebrook - rounded connection hold
    //steps = 'M 68,0 h -68  a 10,10 0 0,0 -10,10 v 10  a 10,10 0 0,0 10,10 h 68  a 10,10 0 0,0 10,-10 v -10  a 10,10 0 0,0 -10,-10 z';
  } else {
    // normal block to block connection highlight (top/bottom)
    this.steps = 'm -36,0 h 25 ' + Blockly.BlockSvg.NOTCH_PATH_LEFT + ' h 10';
  }
  ...
  //render this connection
  this.render(this.sourceBlock_.getSvgRoot());

  //redraw add ControlInput Button if it exists...
  if(this.sourceBlock_.isControlBlock && this.sourceBlock_.controlButton.op === BUTTON_OPERATION_TYPE.ADD) {
    this.sourceBlock_.redrawControlButton();
  }

};

Blockly.RenderedConnection.prototype.render = function (element) {
  element.appendChild(Blockly.Connection.highlightedPath_);
};
