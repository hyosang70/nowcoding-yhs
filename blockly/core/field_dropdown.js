...
Blockly.FieldDropdown.prototype.render_ = function () {
  ...
  if (this.imageJson_) {
    ...
    this.borderRect_.setAttribute('height', this.imageJson_.height - 1);
    this.borderRect_.setAttribute('width',
      this.imageJson_.width + Blockly.BlockSvg.SEP_SPACE_X);
  } else {
    this.renderSelectedText_();

    if (this.name === "OP") {
      this.borderRect_.setAttribute('height', this.size_.height + 1);
    } else {
...
Blockly.FieldDropdown.prototype.renderSelectedImage_ = function () {
  ...
  if (this.sourceBlock_.NowCodingBlockType === "TextLabelDropdownNonEdge") {
  ...
  this.size_.height = Number(this.imageJson_.height) + 1;
  this.size_.width = Number(this.imageJson_.width) + arrowWidth - 9;
  if (this.sourceBlock_.RTL) {
    this.imageElement_.setAttribute('x', arrowWidth);
    this.textElement_.setAttribute('x', -1);
  } else {
    this.textElement_.setAttribute('text-anchor', 'end');
    this.textElement_.setAttribute('x', this.size_.width + 6);

    if (this.sourceBlock_.NowCodingBlockType === "TextLabelDropdownNonEdge") {
        this.textElement_.setAttribute('y', 22);
    } else {
        this.textElement_.setAttribute('y', 18);
    }
