...
Blockly.Toolbox = function(workspace) {
  ...
  this.config_ = {
    ...
    cssSubItemLabel: 'blocklySubTreeLabel',
...
Blockly.Toolbox.prototype.hide = true;
...
Blockly.Toolbox.prototype.getHide = function() {
  return this.hide;
};
Blockly.Toolbox.prototype.setHide = function(param) {
  this.hide = param;
  this.position();
};
...
Blockly.Toolbox.prototype.position = function() {
  ...
  if (this.horizontalLayout_) {
    ...
    if (this.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT) {
      ...
      // Left
      if (this.hide === true) {
        treeDiv.style.left = '-' + treeDiv.offsetWidth + 'px';
      } else {
        treeDiv.style.left = '0';
      }
    }
    ...
    switch (childIn.tagName.toUpperCase()) {
      case 'CATEGORY':
        ...
        if (colour === null || colour === '') {
          ...
          childOut.hexColour = '';
          console.warn(
            'Toolbox category "' + categoryName + '" has unrecognized colour attribute: ' + colour
          );
        }
...
Blockly.Toolbox.TreeControl.prototype.createNode = function(opt_html) {
  console.log('TCL: Blockly.Toolbox.TreeControl.prototype.createNode -> opt_html', opt_html);
  var html = opt_html ? goog.html.SafeHtml.htmlEscape(opt_html) : goog.html.SafeHtml.EMPTY;

  console.log('TCL: Blockly.Toolbox.TreeControl.prototype.createNode -> html', html);
