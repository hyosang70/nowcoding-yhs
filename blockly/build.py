...
# NOWCODING BLOCKLY Build PATH DEFINE  
NOWCODING_GEN_PREFIX_PATH = "../src/assets/third-party/blockly/"
...
class Gen_compressed(threading.Thread):
  ...
  def gen_core(self):
    ...
    target_filename_nowcoding = NOWCODING_GEN_PREFIX_PATH + "blockly_compressed.js"
    ...
    self.do_compile(params, target_filename_nowcoding, filenames, "")

  def gen_accessible(self):
    target_filename = "blockly_accessible_compressed.js"
    target_filename_nowcoding = NOWCODING_GEN_PREFIX_PATH + "blockly_accessible_compressed.js"
    # Define the parameters for the POST request.
    params = [
        ("compilation_level", "SIMPLE_OPTIMIZATIONS"),
        ("use_closure_library", "true"),
  ...
  def gen_blocks(self):
    ...
    target_filename_nowcoding = NOWCODING_GEN_PREFIX_PATH + "blocks_compressed.js"
    # Define the parameters for the POST request.
    params = [
        ("compilation_level", "SIMPLE_OPTIMIZATIONS"),
        ("output_format", "json"),
    ...
    self.do_compile(params, target_filename_nowcoding, filenames, remove)

  def gen_generator(self, language):
    target_filename = language + "_compressed.js"
    target_filename_nowcoding = NOWCODING_GEN_PREFIX_PATH + language + "_compressed.js"
    # Define the parameters for the POST request.
    params = [
        ("compilation_level", "SIMPLE_OPTIMIZATIONS"),
        ("output_format", "json"),
  ...
  def run(self):
    ...
    try:
      ...
      cmd = [
          ...
          "--output_dir", os.path.join("../src/assets/third-party/blockly","msg", "js"),
          "--quiet"]
