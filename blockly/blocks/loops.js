...
Blockly.defineBlocksWithJsonArray([  // BEGIN JSON EXTRACT
  // Block for repeat n times (external number).
  {
    ...
    "NowCodingBlockType": "LoopDefault",
    "message0": "%{BKY_CONTROLS_REPEAT_TITLE}",
    "args0": [{
      "type": "input_value",
      "NowCodingBlockType": "LoopDefaultRow",
      "name": "TIMES",
      "check": "Number"
    }],
  ...
  // The 'controls_repeat_ext' block is preferred as it is more flexible.
  {
    ...
    "NowCodingBlockType": "LoopDefault_2",
    "message0": "%{BKY_CONTROLS_REPEAT_TITLE}",
    "args0": [{
      "type": "field_number",
      "NowCodingBlockType": "LoopDefaultRow",
  ...
  {
    "type": "controls_for",
    "NowCodingBlockType": "LoopDefault_3",
  ...
  // Block for flow statements: continue, break.
  {
    ...
    "NowCodingBlockType": "TextLabelInputHoleLoop",
    "message0": "%1",
    "args0": [{
      "type": "field_dropdown",
      "name": "FLOW",
