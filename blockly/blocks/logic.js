...
Blockly.defineBlocksWithJsonArray([  // BEGIN JSON EXTRACT
  ...
  {
    "type": "controls_if",
    "NowCodingBlockType": "IfTextLabelMutator",
    "message0": "%{BKY_CONTROLS_IF_MSG_IF} %1",
    "args0": [
      {
        "type": "input_value",
        "NowCodingBlockType": "IfStatement",
        "name": "IF0",
        "check": "Boolean"
      }
    ],
    "message1": "%{BKY_CONTROLS_IF_MSG_DO} %1",
    "args1": [
      {
        "type": "input_statement",
        "NowCodingBlockType": "DoStatement",
        "name": "DO0"
      }
    ],
  ...
  // If/else block that does not use a mutator.
  {
    ...
    "message2": "%{BKY_CONTROLS_IF_MSG_DO} %1",
    "args2": [
      {
        "type": "input_statement",
        "name": "ELSE"
  ...
  {
    "type": "logic_compare",
    "NowCodingBlockType": "LogicDefaultNoMargin",
    "message0": "%1 %2 %3",
    "args0": [
      {
        "type": "input_value",
  ...
  {
    "type": "logic_negate",
    "NowCodingBlockType": "LogicNegate",
